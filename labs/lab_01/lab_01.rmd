...
**A1** Engineering, Cooperative Education. University courses is the most surprising, because its so general. I have no idea what it means. 
...
**Q4** Given the results for Q3, what would have made it easier to find the answer? You don't have to know *how* to accomplish this; I want you to describe in words what would make the answer easier to see. How confident are you that the answer you got is the right one, and why? **A4** I would exclude all NAs in the professor column. I'm confident it would make the answer easier to see, because there are tons of NAs and we can't use NA to answer the question. We want to know which professor taught the most. You have to go to tab 8 to find Keith Yearwood as the first actual professor.

**Q5** Take one of the questions you listed in the final question of the pre_lab and try to answer it here in code. If you don't know how to fully answer it, write what code you can and describe in words what else you would need to do. If you got an answer, is it interesting? **A5** Well, I wanted to know how many classes offered had no seats available. I did see a lot of classes with no seats, but performing the code below. I'm not sure if the answer tells me anything interesting. It seems like there were a lot of classes with no seats available. 
