...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** the Maryland county with the highest median household income is Howard County. 
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** Median household incomes in Maryland by county. 
...
Is the difference between Calvert and Montgomery significant? **Answer** No, because the bars overlap. 

Is the difference between Howard and everyone else significant? **Answer** The difference between median income in Howard County and the other counties is significant because there is no overlap in the margins of error. 
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** The average household income for the zip codes associated with highschools in which 60% or more of their graduating class go immediately to college is around $ 111,450 per year. For zipcodes associated with highschools where 40% or less of the graduating class immediately enrolls in college, the median household income is roughly $69,250 per month. 
...
**Task** What is another question you could ask of this data? **Answer** I would be interested in seeing the highschools associated with the zip codes having the highest median income. I would be curious which high schools they are. 
