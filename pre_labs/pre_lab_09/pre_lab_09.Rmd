...
https://datawrapper.dwcdn.net/l6Bxm/1/
...
#saving it back to the md_gov_county dataframe

write_csv(md_gov_total, "data/md_gov_county.csv")
```
...
The previous map showed all of the United States, with some darkened spots around Maryland. This map shows only Maryland. Certain areas of the map are black (Prince George's County, Baltimore City) and the map scales in varieties of gray. 
...
Now, when I hover over the different districts in the map, I see the name of the county I am hovering over, and the percentage of votes for Wes Moore. 
...
https://datawrapper.dwcdn.net/E4FeY/1/
