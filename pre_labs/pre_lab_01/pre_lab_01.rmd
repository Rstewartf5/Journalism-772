...
**Answer** 60712 obs and 8 variables
...
In the space below, write the name of the business from the first row of the "name" column. **Answer** I do not see a black arrow on the right side of the output table, nor do I see any reference to business after running the above code. 
...
**Answer** It is listing the term, year and moth, and displaying how many courses are offered in each term. 
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** The list was organized instead of chronologically from oldest to most recent term, now its listed from the most amount of classes per term to the least amount of classes. 
...
**Answer** compared to the previous codeblock the output now shows the term, followed by the department followed by the number of classes. I think it is showing all of the classes per time in descending order based on the number of classes offered. So among all of the data Business and Management in the fall of 2022 offered the most number of classes. 
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** I no longer see the department, I see the term so year and month followed by a column indicating the number of classes offered in the term, followed by the number of seats in a class. The data is organized largest to smallest based on the number of classes offered. 
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** compared with the previous code block we now have a column for the average number of seats and a column for the median number of seats in every term organized in descending order by the term with the greatest number of classes offered. The top terms both take place in the fall. 
...
**Answer** Well, I can clearly see the department is now listed, and I know that the table is arranged in descending order by the number of total seats. The data is completely different, and I have no idea what happened. I think I'm looking at the total seats, total classes offered, and the average number of seats offered per class in each department. I'm very lost. 
...
1.  What I don't know is if there were any classes offered that had no seats available. 

2.  In 2023 only which department offered the most courses?

3.  Which department does the best job of filling in a professor's name for the offered courses. 
