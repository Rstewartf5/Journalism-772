...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer** The baltimore 911 calls has 3,822 rows and 4 columns. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**
I see a gray bar chart with light gray squares in the background and dark gray vertical bars. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The same chart we were looking at in task 6 is now flipped so the bars run in left to right and the largest colum is on the top. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** There is now a theme in the codeblock called minimal. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The new sections labs has changed - the section appears to allow you to label the graph. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The codeblock groups the calls by date and counts up how many calls were made on each day of the year starting with Feb 06 2022. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** After running the code you get what looks like a Holter Monitor chart if someone were having a heart attack. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The chart produced from running the codeblock below looks similar to the one above. The gray space behind it howver is divided up into tight columns and rows, and the labels on the X axis look a mess. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Running the code block below produces a similar chart to the one above it, however the dates on the x axis are more readible, althought not perfectly. 
