...
3.  Some titles in the title column have portions of the title in all caps. I would make them all uniform by using the str_to_title mutation to mutate the titles so they are all uniform. 
