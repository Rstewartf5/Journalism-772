...
baltimore_homicide <- homicide_data |>
...
###Part of the answer still requires that we create a list of the 50 cities examined and rank them from lowest to highest in terms of homicide arrests. Doing this would validate that Baltimore is one of the 34 cities in which homicide arrests are less frequent now than in 2014. We will need to seek out guidance next week on the best way to make that happen. 



```{r}
#creating a data fram for homicides in 2014
homicide_data|>
  filter(reported_date >= '2014-01-01')
